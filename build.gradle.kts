...
tasks.jar {
    manifest {
        attributes["Main-Class"] = "org.pianomyn.JavaPlayground.Main"
    }
}
...
tasks.named<Checkstyle>("checkstyleMain") {
    ...
    source("src/main/java/org/pianomyn/JavaPlayground")
}

tasks.named<Checkstyle>("checkstyleTest") {
    group = "lint"
    description = "Check Java code style"
    source("src/test/java/org/pianomyn/JavaPlayground/test")
}
